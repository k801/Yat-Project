  ...
  <div class="container-fluid">
    ...
    <section class="container mt-5">
      <div class="row">
       <div class="col-md-6 col-sm-12">
        <img src="images/meal1.jpg" class="float-left h-100 w-50 mx-5" alt="meal-0ne" />
        <h2 class="text-uppercase text-nowrap font-weight-bold">Recipe Name Here</h2>
        <span class="fa fa-star"></span>
        <span class="fa fa-star checked"></span>
        <span class="fa fa-star checked"></span>
        <span class="fa fa-star checked"></span>
        <span class="fa fa-star checked"></span>
        <p >Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum eaque, perferendis veniam.</p>
        <button class="text-uppercase border border-none p-3 text-white my-btn">view details</button>
       </div>

       <div class="col-md-6 col-sm-12">
      <img src="images/meal2.jpg" class="float-left h-100 w-50 mx-5" alt="meal-Two" />
      <h2 class="text-uppercase text-nowrap font-weight-bold">Recipe Name Here</h2>
      <span class="fa fa-star"></span>
      <span class="fa fa-star checked"></span>
      <span class="fa fa-star checked"></span>
   ...
   <hr class="mt-5"/>
      ...
      <section class="container mt-5">
        ...
        <img src="images/meal3.jpg" class="float-left h-100 w-50 mx-5" alt="meal-Three" />
        <h2 class="text-uppercase text-nowrap font-weight-bold">Recipe Name Here</h2>
        <span class="fa fa-star"></span>
        <span class="fa fa-star checked"></span>
        <span class="fa fa-star checked"></span>
      ...
      <div class="col-md-6 col-sm-12">
        ...
        <img src="images/meal4.jpg" class="float-left h-100 w-50 mx-5" alt="meal-Four" />
        <h2 class="text-uppercase text-nowrap font-weight-bold">Recipe Name Here</h2>
        <span class="fa fa-star"></span>
        <span class="fa fa-star checked"></span>
        <span class="fa fa-star checked"></span>
    ...
    <section class="container mt-5">
      ...
      <img src="images/meal5.jpg" class="float-left h-100 w-50 mx-5" alt="meal-Five" />
      <h2 class="text-uppercase text-nowrap font-weight-bold">Recipe Name Here</h2>
      <span class="fa fa-star"></span>
      <span class="fa fa-star checked"></span>
      <span class="fa fa-star checked"></span>
    ...
    <div class="col-md-6 col-sm-12">
      ...
      <img src="images/meal6.jpg" class="float-left h-100 w-50 mx-5" alt="meal-Six" />
      <h2 class="text-uppercase text-nowrap font-weight-bold">Recipe Name Here</h2>
      <span class="fa fa-star"></span>
      <span class="fa fa-star checked"></span>
      <span class="fa fa-star checked"></span>
    ...
    <section class="container">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-sm-12">
          <div class="card border border-0">
            <img src="images/recipe1.jpg" class="card-img-top my-img" alt="recipe-image">
            <div class="mt-3">
        ...
        <div class="col-md-3 col-sm-12">
          <div class="card border border-0">
            <img src="images/recipe2.jpg" class="card-img-top my-img" alt="recipe-image">
            <div class="mt-3">
              <h6 class="card-title text-uppercase">food name</h6>
              <span class="fa fa-star"></span>
              <span class="fa fa-star checked"></span>
        ...
        <div class="col-md-3 col-sm-12">
          <div class="card border border-0">
            <img src="images/recipe3.jpg" class="card-img-top my-img" alt="recipe-image">
            <div class="mt-3">
              <h6 class="card-title text-uppercase">food name</h6>
              <span class="fa fa-star"></span>
              <span class="fa fa-star checked"></span>
        ...
        <div class="col-md-3 col-sm-12">
          <div class="card border border-0">
            <img src="images/recipe4.jpg" class="card-img-top my-img" alt="recipe-image">
            <div class="mt-3">
              <h6 class="card-title text-uppercase">food name</h6>
              <span class="fa fa-star"></span>
              <span class="fa fa-star checked"></span>
      ...
      <div class="text-center m-5">
        <span class="dot span-checked"></span>
        <span class="dot"></span>
        <span class="dot"></span>
      </div>
    </section>
